...
//
#define DUNGEON_GRID_CHUNK_HEIGHT_MAX 4 // Levels are split into grids. Each grid can have a room.
#define DUNGEON_GRID_CHUNK_WIDTH_MAX  4 // Rooms across and down
#define DUNGEON_MAX_DEPTH             2 // Max difficulty level
